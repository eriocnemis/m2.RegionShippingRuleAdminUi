...
namespace Eriocnemis\RegionShippingRuleAdminUi\Ui\Component;
...
class MassAction extends AbstractComponent
{
    ...
    public function isAllowed($actionType): bool
    {
        ...
        switch ($actionType) {
            case 'delete':
                $isAllowed = $this->authorization->isAllowed('Eriocnemis_Region::shipping_rule_delete');
                break;
            case 'status':
                $isAllowed = $this->authorization->isAllowed('Eriocnemis_Region::shipping_rule_edit');
                break;
        }
        return $isAllowed;
    }
